# badads
Bad Ads- Testing AI models against visual prompt injections/ fake malicious ads 

note: to run the code open it in colaboratory and run the cells, you can download the zip below of all the ads,websites if you'd like!
...
works best on model with learn vision rather than something like OCR- as the text isnt too easily readable.
